...
<html>
	...
	<body>
		<div class="background">
			...
			<h1>Avatar Data Entry Form</h1>
			<form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
				<label for="idquery">Which Avatar are you entering?</label>
			...
			<form action="<?php echo htmlentities($_SERVER['PHP_SELF']); ?>" method="post">
				...
				<!----------------------------------------------------------->
				<label for="avatar_era">Avatar's Era (dates):</label>
				<input type="text" id="avatar_era" name="avatar_era" placeholder="XXX BG/AG - XXX BG/AG"><br><br>
				<!----------------------------------------------------------->
				Avatar's Primary Bending Type:<br>
				<input type="radio" id="water" name="avatar_maintype" value="water">
				<label for="water">Water</label><br>
				<input type="radio" id="earth" name="avatar_maintype" value="earth">
				<label for="earth">Earth</label><br>
				<input type="radio" id="fire" name="avatar_maintype" value="fire">
				<label for="fire">Fire</label><br>
				<input type="radio" id="air" name="avatar_maintype" value="air">
			...
			if(isset($_POST['bend_id']) && $_POST['bend_id'] != "") {
				...
				$avatar_era = mysqli_real_escape_string($con, trim($_POST['avatar_era']));
				$avatar_maintype = mysqli_real_escape_string($con, trim($_POST['avatar_maintype']));

				$query2 ="INSERT INTO avatar (bend_id, avatar_era, avatar_maintype) VALUES ('$bend_id', '$avatar_era', '$avatar_maintype')";
